...
import {
    GuestCreateBookingOperation
} from '../../../../src/Domain/Booking/Operation/GuestCreateBookingOperation';
...
describe('GuestCreateBookingOperation', () => {
  ...
  let operation: GuestCreateBookingOperation;
  ...
  beforeEach(() => {
    ...
    operation = new GuestCreateBookingOperation(
      bookingRepository,
      bookingStatsRepository,
      logger
    );
